    ...
    const getData = async () => {
      try {
        ...
        const response = await axios.get(
          `https://culture-capsule-backend.onrender.com/api/posts/category/Folklore%20and%20Stories?language=${language}&page=${currentPage}&limit=${itemsPerPage}`
        );
